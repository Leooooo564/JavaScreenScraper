...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        // WebElement tempWidgetConatiner =
        // driver.findElement(By.cssSelector("#accordion"));
        // WebElement VPWidget = tempWidgetConatiner.findElement(By.cssSelector(
        // "div:nth-child(3) > div.panel-body > ul > li.ui-state-default.t17-1 > div >
        // div.logobox > div.logoview > a"));
        ...
        // public static void login(WebDriver driver, String url, String user, String
        // pw) {
        ...
        // WebElement DayListCon = driver.findElement(By.cssSelector("#content >
        // div.row.clearfix"));
        ...
        // for (WebElement Day :
        // DayListCon.findElements(By.cssSelector("div.panel-info[style=\"display:
        // none;\"]"))) {
